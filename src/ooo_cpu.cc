...
void O3_CPU::initialize_core()
{
    ...
    L1I.lower_level = &L2C;             // L1I -> L2C
    L1D.lower_level = &L2C;             // L1D -> L2C
    L2C.upper_level_icache[cpu] = &L1I; // L2C -> L1I
    L2C.upper_level_dcache[cpu] = &L1D; // L2C -> L1D
    L2C.lower_level = &uncore.LLC;      // L2C -> LLC
